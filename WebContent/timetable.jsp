...
<div class="container-fluid text-center" style="overflow:hidden; position:relative;">    
  <div class="row content">
		...
		<div class="col-sm-10 text-left" style="position: relative; top: 0; bottom: 0; right: 0;">
	    	<!-- 컨텐츠 -->
			<br><br>
			<div class="panel panel-default">
			<div class="bg-color2 panel-heading text-left" style="padding: 2rem 5rem;">
			<h1><a href="timetable.jsp" class="text-color1">근무 일정표</a></h1>
			</div>
						...
						for(int dayIdx = 0; dayIdx < days.length; dayIdx++)
						{
							if(schList.size() == 0) 
							{
								...
								if(sdto.getSday().equals(days[dayIdx]) && sdto.getStime() == time)
								{
									...
									{
										%>
										<td rowspan="<%=(int)diff%>" style="vertical-align: middle; background-color: #d5e4ec;">
										</td>
										<%
									}
									else //alist.size() >= 1
...
<footer class="container-fluid text-center bg-color1" style="border-top: 1px solid #1f2945; position: relative; top: 0; bottom: 0;">
